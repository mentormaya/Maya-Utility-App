...
"}")
        ...
        self.dashboard_menu.setIcon(icon7)
...
"}")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/icons/tool.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.utilities_menu.setIcon(icon8)
...
"}")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/icons/link.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.api_menu.setIcon(icon9)
...
"}")
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/icons/dollar-sign.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tax_menu.setIcon(icon10)
...
"}")
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icons/icons/book.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.lms_menu.setIcon(icon11)
...
"}")
        ...
        self.numbers_page.setIcon(icon10)
...
"border-top-right-radius: 0px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Tax Menus"))
